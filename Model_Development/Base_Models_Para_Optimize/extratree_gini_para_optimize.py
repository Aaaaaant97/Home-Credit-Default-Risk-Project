...
# -*- coding: utf-8 -*-
"""
ExtraTrees (Gini) baseline + Coarse Grid Search (max_depth × min_samples_leaf)
- Automatically finds the best combination by OOF AUC
- Retrains with the best params and exports: submission / OOF / feature importance /
...
CFG = {
    ...
    "target": "TARGET",
    "id_col": "SK_ID_CURR",
    # You may also switch to your screened F.L.I feature files
    "train_path": "../Features/All_application_train.csv",
    "test_path": "../Features/All_application_test.csv",
    "out_dir": "baseline_extratrees_gini_grid",

    # ExtraTrees base params (grid will override max_depth & min_samples_leaf)
    "et_params": {
        "n_estimators": 800,          # tunable: 500–1200
        "criterion": "gini",          # use "entropy" for information gain if desired
...
def preprocess(train, test, target, id_col):
    ...
    # Label Encoding (fit on combined data to avoid unseen categories)
    for col in cat_cols:
        le = LabelEncoder()
